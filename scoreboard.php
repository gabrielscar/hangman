<div class="row mt-4" id="scoreboardRow">
    ...
    <div class="col-md-6">
        <ul class="list-group">
            ...
            <li class="list-group-item d-flex justify-content-between">Incorect Guesses<span class="badge bg-primary"><?php echo $_SESSION['incorrectGuesses'] ?></span></li>
            ...
            <li class="list-group-item d-flex justify-content-between">Total Games Played<span class="badge bg-primary"><?php echo $_SESSION['gamesLost'] + $_SESSION['gamesWon'] ?></span></li>
